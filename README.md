...
| Prerequisites | Basic proficiency in using Ardunio Micro Contollers to interface with LEDs, switches, potentiometers, stepper and servo motors, sensors, transceivers.<br>CNC and Basic woodworking skills if you want to build a full cockpit.</li><li>Wife permission</li></ul> |
| Date | February 2021 |
