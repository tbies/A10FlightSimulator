...
| Prerequisites | <ul><li>Basic proficiency in using Ardunio Micro Contollers to interface with LEDs, switches, potentiometers, stepper and servo motors, sensors, transceivers.</li></ul><li><ul>CNC and woodworking skills if you want to build a full cockpit.</ul></li><ul><li>Wife permission</li></ul> |
