...
| Prerequisites | <li>Basic proficiency in using Ardunio Micro Contollers to interface with LEDs, switches, potentiometers, stepper and servo motors, sensors, transceivers.</li><br><li>CNC and Basic woodworking skills if you want to build a full cockpit.</li><br><li>Wife permission</li></ul> |
| Date | February 2021 |
